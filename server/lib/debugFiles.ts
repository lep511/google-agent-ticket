 ...
 * lugar de esparcirse por ella: hoy, la copia heredada
 * `sub_agents_debug_<entrada>.txt` de cada ejecución. Los logs de ejecución con
 * nombre por `runId` siguen en `run_logs/`, porque se sirven como estáticos
 * (ver `runLogNaming.ts`).
 *
