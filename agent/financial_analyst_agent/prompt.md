Perform a comprehensive document analysis on {{input}}. Find and analyze recent SEC filings and public stock documents for {{input}}. Make sure that you are looking for the most up to date documents of the existing quarter or the quarter before (if documents have not been out yet for the existing quarter, look for the last quarter). {{instruction}}
