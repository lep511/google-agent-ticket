...
`debug/debug_delta.log` is no longer produced: it held the raw deltas of the remote agent
stream, and the agents now run in-process through the Strands Agents SDK. Existing copies are
